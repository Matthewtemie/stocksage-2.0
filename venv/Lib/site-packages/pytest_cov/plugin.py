...
COVERAGE_SQLITE_WARNING_RE2 = re.compile(
    "unclosed\\ database\\ in\\ <sqlite3\\.Connection\\ object\\ at", re.I
)
...
class StoreReport(argparse.Action):
    ...
    def _validate_markdown_dest_files(self, cov_report_options, parser):
        ...
        if markdown_file == markdown_append_file:
            ...
            error_message += (
                " Please redirect one of them using :DEST (e.g. --cov-report=markdown:dest_file.md)"
            )
