                ...
                if cls.__pydantic_root_model__:
                    ...
                    if cls.__doc__ and metadata.get("pydantic_js_updates", {}).get("description"):
                        ...
                        update_core_metadata(
                            metadata,
                            pydantic_js_updates={"description": inspect.cleandoc(cls.__doc__)},
                        )
...
_VALIDATOR_F_MATCH: Mapping[
    ...
    ("before", "with-info"): lambda f, schema: core_schema.with_info_before_validator_function(
        f, schema
    ),
    ("after", "with-info"): lambda f, schema: core_schema.with_info_after_validator_function(
        f, schema
    ),
