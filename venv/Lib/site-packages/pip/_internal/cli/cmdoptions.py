...
def _handle_uploaded_prior_to(option: Option, opt: str, value: str, parser: OptionParser) -> None:
    """
    ...
    if match:
        ...
        parser.values.uploaded_prior_to = datetime.now(timezone.utc) - timedelta(days=days)
        return
...
def _handle_all_releases(option: Option, opt_str: str, value: str, parser: OptionParser) -> None:
...
def _handle_only_final(option: Option, opt_str: str, value: str, parser: OptionParser) -> None:
    existing = _get_release_control(parser.values, option)
    existing.handle_mutual_excludes(
        value,
        existing.only_final,
