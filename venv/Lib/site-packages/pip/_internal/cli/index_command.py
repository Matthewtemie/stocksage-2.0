...
def _pip_self_version_check_fetch(session: PipSession, options: Values) -> UpgradePrompt | None:
...
class IndexGroupCommand(Command, SessionCommandMixin):
    ...
    def should_exclude_prerelease(self, options: Values, package_name: NormalizedName) -> bool:
        """
