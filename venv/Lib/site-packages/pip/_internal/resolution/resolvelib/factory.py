...
class Factory:
    ...
    def _get_locked_installation_candidate(
        ...
        return InstallationCandidate(name, str(locked_ireq.locked_version), locked_ireq.locked_link)
    ...
    def _iter_found_candidates(
        ...
        if (
            ...
            template.hash_options = {k: list(v) for k, v in constraint_hash_options.items()}
        ...
        def iter_index_candidate_infos() -> Iterator[IndexCandidateInfo]:
            if locked_ican := self._get_locked_installation_candidate(ireqs, name, specifier):
