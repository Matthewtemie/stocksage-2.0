...
def get_context(method=None):
    ...
    try:
        ...
        raise ValueError(f"Unknown context '{method}'. Value should be in " f"{START_METHODS}.")
...
def _count_physical_cores_linux():
    ...
    cpu_info = subprocess.run("cat /proc/cpuinfo".split(), capture_output=True, text=True)
    cpu_info = cpu_info.stdout.splitlines()
