        ...
        for corporate_action_type, corporate_actions in raw_data.items():
            if corporate_action_type == "forward_splits":
                parsed_corporate_actions[corporate_action_type] = [
                    ForwardSplit(corporate_action_type=corporate_action_type, **corporate_action)
                    for corporate_action in corporate_actions
                ]
            elif corporate_action_type == "reverse_splits":
                parsed_corporate_actions[corporate_action_type] = [
                    ReverseSplit(corporate_action_type=corporate_action_type, **corporate_action)
                    for corporate_action in corporate_actions
                ]
            elif corporate_action_type == "unit_splits":
                parsed_corporate_actions[corporate_action_type] = [
                    UnitSplit(corporate_action_type=corporate_action_type, **corporate_action)
                    for corporate_action in corporate_actions
                ]
            elif corporate_action_type == "stock_dividends":
                parsed_corporate_actions[corporate_action_type] = [
                    StockDividend(corporate_action_type=corporate_action_type, **corporate_action)
                    for corporate_action in corporate_actions
                ]
            elif corporate_action_type == "cash_dividends":
                parsed_corporate_actions[corporate_action_type] = [
                    CashDividend(corporate_action_type=corporate_action_type, **corporate_action)
                    for corporate_action in corporate_actions
                ]
            elif corporate_action_type == "spin_offs":
                parsed_corporate_actions[corporate_action_type] = [
                    SpinOff(corporate_action_type=corporate_action_type, **corporate_action)
                    for corporate_action in corporate_actions
                ]
            elif corporate_action_type == "cash_mergers":
                parsed_corporate_actions[corporate_action_type] = [
                    CashMerger(corporate_action_type=corporate_action_type, **corporate_action)
                    for corporate_action in corporate_actions
                ]
            elif corporate_action_type == "stock_mergers":
                parsed_corporate_actions[corporate_action_type] = [
                    StockMerger(corporate_action_type=corporate_action_type, **corporate_action)
                    for corporate_action in corporate_actions
                ]
                ...
                parsed_corporate_actions[corporate_action_type] = [
                    Redemption(corporate_action_type=corporate_action_type, **corporate_action)
                    for corporate_action in corporate_actions
                ]
            elif corporate_action_type == "name_changes":
                parsed_corporate_actions[corporate_action_type] = [
                    NameChange(corporate_action_type=corporate_action_type, **corporate_action)
                    for corporate_action in corporate_actions
                ]
