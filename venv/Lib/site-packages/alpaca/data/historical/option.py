...
class OptionHistoricalDataClient(RESTClient):
    ...
    def get_option_bars(self, request_params: OptionBarsRequest) -> Union[BarSet, RawData]:
    ...
    def get_option_trades(self, request_params: OptionTradesRequest) -> Union[TradeSet, RawData]:
