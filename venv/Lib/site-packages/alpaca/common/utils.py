...
def validate_symbol_or_asset_id(symbol_or_asset_id: Union[UUID, str]) -> Union[UUID, str]:
    """
    ...
    raise ValueError("symbol_or_asset_id must be a UUID of an asset id or a string of a symbol.")


def validate_symbol_or_contract_id(symbol_or_contract_id: Union[UUID, str]) -> Union[UUID, str]:
    """
