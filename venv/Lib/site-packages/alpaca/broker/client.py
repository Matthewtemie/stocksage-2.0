    ...
    **Note on the `handle_pagination` param you'll see across these methods**
    ...
    def _iterate_over_pages(
        ...
        while True:
            if max_items_limit is not None:
                normalized_page_size = min(int(max_items_limit) - total_items, page_size)
            ...
            if max_items_limit is not None and num_items_returned + total_items > max_items_limit:
    ...
    def upload_documents_to_account(
        ...
        if len(document_data) > BROKER_DOCUMENT_UPLOAD_LIMIT:
            raise ValueError(f"document_data cannot be longer than {BROKER_DOCUMENT_UPLOAD_LIMIT}")
    ...
    def get_account_activities(
        ...
        """
        handle_pagination = BrokerClient._validate_pagination(max_items_limit, handle_pagination)
    ...
    def download_trade_document_for_account_by_id(
        ...
        target_url = (
            f"{base_url}/{self._api_version}/accounts/{account_id}/documents/{document_id}/download"
        )
        num_tries = 0
    ...
    def create_ach_relationship_for_account(
        ...
        if not isinstance(ach_data, (CreateACHRelationshipRequest, CreatePlaidRelationshipRequest)):
            raise ValueError(
    ...
    def delete_ach_relationship_for_account(
        ...
        """
        account_id = validate_uuid_id_param(account_id)
        ach_relationship_id = validate_uuid_id_param(ach_relationship_id, "ach_relationship_id")
    ...
    def create_transfer_for_account(
        ...
        """
        account_id = validate_uuid_id_param(account_id)
        response = self.post(f"/accounts/{account_id}/transfers", transfer_data.to_request_fields())
    ...
    def get_transfers_for_account(
        ...
        iterator = self._get_transfers_iterator(
            ...
            transfers_filter=(
                transfers_filter if transfers_filter is not None else GetTransfersRequest()
            ),
            max_items_limit=max_items_limit,
        )
    ...
    def get_open_position_for_account(
        ...
        response = self.get(f"/trading/accounts/{account_id}/positions/{symbol_or_asset_id}")
    ...
    def get_calendar(
        ...
        result = self.get("/calendar", filters.to_request_fields() if filters is not None else {})
    ...
    def add_asset_to_watchlist_for_account_by_id(
        ...
        result = self.post(f"/trading/accounts/{account_id}/watchlists/{watchlist_id}", params)
    ...
    def remove_asset_from_watchlist_for_account_by_id(
        ...
        result = self.delete(f"/trading/accounts/{account_id}/watchlists/{watchlist_id}/{symbol}")
    ...
    def get_journal_by_id(self, journal_id: Union[UUID, str] = None) -> Union[Journal, RawData]:
        """
    ...
    def replace_order_for_account_by_id(
        ...
        response = self.patch(f"/trading/accounts/{account_id}/orders/{order_id}", params)
    ...
    def get_corporate_announcement_by_id(
        ...
        response = self.get(f"/corporate_actions/announcements/{corporate_announcment_id}")
    ...
    def get_account_status_events(self, filter: Optional[GetEventsRequest] = None) -> Iterator:
        """
    ...
    def get_transfer_events(self, filter: Optional[GetEventsRequest] = None) -> Iterator:
        """
    ...
    def create_portfolio(
        ...
        response = self.post("/rebalancing/portfolios", data=portfolio_request.to_request_fields())
    ...
    def get_all_portfolios(
        ...
        response = self.get("/rebalancing/portfolios", filter.to_request_fields() if filter else {})
    ...
    def get_portfolio_by_id(self, portfolio_id: Union[UUID, str]) -> Union[Portfolio, RawData]:
        """
    ...
    def get_all_subscriptions(
        ...
        return BrokerClient._return_paginated_result(subscriptions_iterator, handle_pagination)
    ...
    def create_manual_run(
        ...
        response = self.post("/rebalancing/runs", data=rebalancing_run_request.to_request_fields())
