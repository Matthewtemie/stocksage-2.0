...
class TradingClient(RESTClient):
    ...
    def get_orders(self, filter: Optional[GetOrdersRequest] = None) -> Union[List[Order], RawData]:
        """
    ...
    def get_open_position(self, symbol_or_asset_id: Union[UUID, str]) -> Union[Position, RawData]:
        """
    ...
    def set_account_configurations(
        ...
        """
        response = self.patch("/account/configurations", data=account_configurations.model_dump())
    ...
    def get_option_contracts(
        ...
        if "underlying_symbols" in params and isinstance(request.underlying_symbols, list):
    ...
    def get_option_contract(self, symbol_or_id: Union[UUID, str]) -> Union[OptionContract, RawData]:
        """
        The option contracts API serves as the master list of option contracts available for trade and data consumption from Alpaca.
