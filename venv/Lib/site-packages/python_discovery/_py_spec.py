...
def _parse_spec_pattern(string_spec: str) -> PythonSpec | None:
    ...
    return PythonSpec(
        string_spec, impl, major, minor, micro, arch, None, free_threaded=threaded, machine=machine
    )
...
def _parse_specifier(string_spec: str) -> PythonSpec | None:
    ...
    if impl == "graalvm":
        impl = "graalpy"
    return PythonSpec(
        string_spec, impl, None, None, None, None, None, version_specifier=version_specifier
    )
