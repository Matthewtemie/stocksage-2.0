...
class PythonInfo:  # noqa: PLR0904
    ...
    def _satisfies_path(self, spec: PythonSpec) -> bool:
        ...
        if sys.platform == "win32":
            ...
            spec_path = (
                spec_path[: -len(suffix)] if suffix and spec_path.endswith(suffix) else spec_path
            )
    ...
    def _satisfies_version_specifier(self, spec: PythonSpec) -> bool:
        ...
        for specifier in spec.version_specifier:
            ...
            release = ".".join(
                str(c)
                for c in [version_info.major, version_info.minor, version_info.micro][:precision]
            )
            if (
    ...
    def from_exe(  # noqa: PLR0913
        ...
        *,
        ...
        proposed = from_exe(
            cls, cache, exe, env=env, raise_on_error=raise_on_error, ignore_cache=ignore_cache
        )
