...
if FASTAPI_INSTALLED:
    ...
    class UploadFile(fastapi.UploadFile, Generic[T]):
        ...
        if PYDANTIC_V2:
            ...
            @classmethod
            def pydantic_validate_v2(cls: type["UploadFile"], obj: Any, dataframe_type) -> Any:
                """
                ...
                validated_data = dataframe_type.pydantic_validate(obj.file, schema_model)
                obj.file.seek(0)
            ...
            @classmethod
            def pydantic_validate_v1(cls: type["UploadFile"], obj: Any, field: ModelField) -> Any:
                """
                Pydantic validation method for validating dataframes in the context
                of a file upload.
                """
