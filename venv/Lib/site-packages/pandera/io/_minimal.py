...
def _prune_check_list(serialized: list[Any] | None, checks: list[Any] | None) -> None:
...
def apply_minimal_dataframe_container(out: dict[str, Any], schema: Any) -> None:
...
def _prune_data_array_like(out: dict[str, Any], schema: Any, *, pop_version: bool) -> None:
    if pop_version:
        out.pop("version", None)
