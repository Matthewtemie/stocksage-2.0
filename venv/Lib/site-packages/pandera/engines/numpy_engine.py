...
class DataType(dtypes.DataType):
    ...
    type: DTypeLike = dataclasses.field(default=np.dtype("object"), repr=False, init=False)
    ...
    def try_coerce(
        ...
        try:
            ...
            raise errors.ParserError(
                ...
                failure_cases=utils.numpy_pandas_coerce_failure_cases(data_container, self.type),
            ) from exc
