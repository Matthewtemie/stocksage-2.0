...
class Decimal(DataType, dtypes.Decimal):
    ...
    def __init__(self, precision: int = dtypes.DEFAULT_PYTHON_PREC, scale: int = 0):
        object.__setattr__(self, "type", dt.Decimal(precision=precision, scale=scale))
    ...
    def from_parametrized_dtype(cls, ibis_dtype: dt.Decimal):
        ...
        precision = (
            ibis_dtype.precision if ibis_dtype.precision is not None else dtypes.DEFAULT_PYTHON_PREC
        )
...
class DateTime(DataType, dtypes.DateTime):
    ...
    def __init__(
        ...
        object.__setattr__(self, "type", dt.Timestamp(timezone=timezone, scale=scale))
