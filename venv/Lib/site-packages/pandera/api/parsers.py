...
class Parser(BaseParser):
    ...
    def __init__(
        ...
        **parser_kwargs,
        ...
        self.name = name or getattr(self._parser_fn, "__name__", self._parser_fn.__class__.__name__)
        self.title = title
        self.description = description

    def __call__(self, parse_obj: Any, column: str | None = None) -> ParserResult:
