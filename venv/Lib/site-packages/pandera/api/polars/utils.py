...
def get_validation_depth(check_obj: PolarsCheckObjects) -> ValidationDepth:
    ...
    if isinstance(check_obj, pl.LazyFrame) and config_global.validation_depth is None:
        ...
        config_ctx.validation_depth is None or config_ctx.validation_depth is None
    ):
