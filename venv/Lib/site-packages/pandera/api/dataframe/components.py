...
class ComponentSchema(Generic[TDataObject], BaseSchema):
    ...
    def _allow_groupby(self):
        ...
        raise NotImplementedError(  # pragma: no cover
            "The _allow_groupby property must be implemented by subclasses " "of SeriesSchemaBase"
        )
    ...
    def __repr__(self):
        return f"<Schema {self.__class__.__name__}" f"(name={self.name}, type={self.dtype!r})>"
