...
class Check(BaseCheck):
    ...
    def __init__(
        ...
        **check_kwargs,
        ...
        self.name = name or getattr(self._check_fn, "__name__", self._check_fn.__class__.__name__)
        ...
        if groupby is None and groups is not None:
            raise ValueError(
                "`groupby` argument needs to be provided when `groups` " "argument is defined"
            )
        ...
        **kwargs,
        ...
        if len(args) >= 2:
            ...
            if not min_value_provided and not max_value_provided:
                raise TypeError("in_range() missing required argument: 'max_value'")
        ...
        if not min_value_provided and not max_value_provided:
            raise TypeError("in_range() missing required arguments: 'min_value' and 'max_value'")
        if not min_value_provided:
            raise TypeError("in_range() missing required argument: 'min_value'")
    ...
    @classmethod
    def isin(cls, *args, allowed_values: Iterable | None = None, **kwargs) -> "Check":
        ...
        try:
            ...
            raise ValueError(f"Argument allowed_values must be iterable. Got {values}") from exc
        return cls.from_builtin_check_name(
            "isin",
            kwargs,
            error=f"isin({values})",
    ...
    @classmethod
    def notin(cls, *args, forbidden_values: Iterable | None = None, **kwargs) -> "Check":
        ...
        try:
            ...
            raise ValueError(f"Argument forbidden_values must be iterable. Got {values}") from exc
        return cls.from_builtin_check_name(
            "notin",
            kwargs,
