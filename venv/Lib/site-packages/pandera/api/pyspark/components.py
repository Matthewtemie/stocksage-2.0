...
class Column(ComponentSchema[PySparkDataFrameTypes]):
    ...
    def _validate_attributes(self):
        if self.name is not None and not isinstance(self.name, str) and self.regex:
    ...
    def get_regex_columns(self, check_obj: Any) -> Iterable:
        ...
        """
        return self.get_backend(check_type=PySparkDataFrameTypes).get_regex_columns(self, check_obj)
