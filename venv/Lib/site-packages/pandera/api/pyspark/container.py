...
class DataFrameSchema(_DataFrameSchema[PySparkDataFrameTypes]):
    ...
    def to_structtype(self) -> StructType:
        ...
        """
        fields = [
            StructField(column, self.columns[column].dtype.type, True) for column in self.columns
        ]
    ...
    def to_yaml(self, stream: os.PathLike | None = None, *, minimal: bool = True) -> str | None:
