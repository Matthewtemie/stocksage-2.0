...
class BaseParser(metaclass=MetaParser):
    ...
    def __eq__(self, other: object) -> bool:
        ...
        are_parser_fn_objects_equal = self._get_parser_fn_code() == other._get_parser_fn_code()
        ...
        return are_parser_fn_objects_equal and are_all_other_parser_attributes_equal
