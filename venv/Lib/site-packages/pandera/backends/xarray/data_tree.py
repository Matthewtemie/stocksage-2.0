...
class DataTreeSchemaBackend(XarraySchemaBackend):
    ...
    def check_attrs(self, check_obj, schema: DataTreeSchema) -> list[CoreCheckResult]:
        results: list[CoreCheckResult] = []
        if not schema.attrs:
            return results
    ...
    @validate_scope(scope=ValidationScope.SCHEMA)
    def check_strict_children(self, check_obj, schema: DataTreeSchema) -> list[CoreCheckResult]:
        results: list[CoreCheckResult] = []
