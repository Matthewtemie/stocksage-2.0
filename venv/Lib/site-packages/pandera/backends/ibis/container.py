...
class DataFrameSchemaBackend(IbisSchemaBackend):
    ...
    def collect_column_info(self, check_obj: ibis.Table, schema: DataFrameSchema) -> ColumnInfo:
    ...
    def check_column_names_are_unique(
        ...
        raise NotImplementedError("Ibis does not support duplicate column names")
    ...
    def check_column_values_are_unique(
        ...
        for lst in temp_unique:
            ...
            if keep_setting == "first":
                ...
                duplicated = (_.count() - ibis.row_number()).over(group_by=subset) > 1
            else:
