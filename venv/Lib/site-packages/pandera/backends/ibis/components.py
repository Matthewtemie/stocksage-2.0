...
class ColumnBackend(IbisSchemaBackend):
    ...
    def check_nullable(self, check_obj: ibis.Column, schema: Column) -> CoreCheckResult:
        ...
        if check_obj.type().is_floating() and ibis.get_backend(check_obj).has_operation(ops.IsNan):
    ...
    def check_dtype(self, check_obj: ibis.Column, schema: Column) -> CoreCheckResult:
        passed = True
        failure_cases = None
        msg = None
