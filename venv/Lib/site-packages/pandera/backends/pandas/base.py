...
class PandasSchemaBackend(BaseSchemaBackend):
    ...
    def subsample(
        ...
        if sample is not None:
            pandas_obj_subsample.append(check_obj.sample(sample, random_state=random_state))
        return (
            check_obj
        ...
        *args,
        ...
        if not passed:
            if check_result.failure_cases is None:
                ...
                failure_cases = reshape_failure_cases(check_result.failure_cases, check.ignore_na)
    ...
    def drop_invalid_rows(self, check_obj, error_handler: ErrorHandler):
        ...
        for err in error_handler.schema_errors:
            ...
            if isinstance(err.failure_cases, pd.Series):
                ...
                try:
                    if hasattr(check_obj.index, "dtype") and hasattr(index_values, "astype"):
