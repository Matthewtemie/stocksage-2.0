...
class PandasParserBackend(BaseParserBackend):
    ...
    def preprocess(self, parse_obj, key) -> pd.Series | pd.DataFrame | dict[str, pd.DataFrame]:
    ...
    def preprocess_table(self, parse_obj) -> Union[pd.DataFrame, dict[str, pd.DataFrame]]:
        return parse_obj
    ...
    def postprocess(
        ...
        return ParserResult(parser_output=parser_output, parsed_object=parse_obj)
