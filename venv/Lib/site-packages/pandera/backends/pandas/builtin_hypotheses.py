...
def two_sample_ttest(
    *samples: tuple[PandasData, ...],
    ...
    assert len(samples) == 2, "Expected two sample ttest data to contain exactly two samples"
...
def one_sample_ttest(
    *samples: tuple[PandasData, ...],
    ...
    assert len(samples) == 1, "Expected one sample ttest data to contain only one sample"
