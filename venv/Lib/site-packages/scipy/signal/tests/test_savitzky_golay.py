...
pytestmark = pytest.mark.skip_xp_backends("dask.array", reason="linalg.lstsq is missing rcond")
...
@xfail_xp_backends("torch", reason="torch loses precision (worse with f32 default dtype)")
@make_xp_test_case(savgol_coeffs)
