import math
import numpy as np
from scipy._lib._array_api import assert_array_almost_equal, xp_assert_close, make_xp_test_case
...
class TestC2D:
    ...
    def test_foh(self, xp):
        ...
        cd_truth = cc
        dd_truth = xp.asarray([[0.260262223725224], [0.297442541400256], [-0.144098411624840]])
        dt_requested = 0.5
    ...
    def test_bilinear(self, xp):
        ...
        cd_truth = xp.asarray([[1.0, 4.0 / 3.0], [4.0 / 3.0, 4.0 / 3.0], [4.0 / 3.0, 1.0 / 3.0]])
    ...
    def test_zerospolesgain(self, xp):
        ...
        polls_d = xp.asarray(
            [0.938148335039729 + 0.346233593780536j, 0.938148335039729 - 0.346233593780536j]
        )
        k_d = 1.0
