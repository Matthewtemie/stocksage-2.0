...
capabilities_overrides = {
    ...
    "bilinear_zpk": xp_capabilities(
        cpu_only=True, exceptions=["cupy", "torch"], jax_jit=False, allow_dask_compute=True
    ),
    ...
    "dlti": xp_capabilities(np_only=True, reason="works in CuPy but delegation isn't set up yet"),
    ...
    "firls": xp_capabilities(cpu_only=True, allow_dask_compute=True, jax_jit=False, reason="lstsq"),
    ...
    "lfilter_zi": xp_capabilities(cpu_only=True, allow_dask_compute=True, jax_jit=False),
    "lfiltic": xp_capabilities(cpu_only=True, exceptions=["cupy"], allow_dask_compute=True),
    ...
    "lp2bp_zpk": xp_capabilities(
        cpu_only=True, exceptions=["cupy", "torch"], allow_dask_compute=True, jax_jit=False
    ),
    ...
    "lti": xp_capabilities(np_only=True, reason="works in CuPy but delegation isn't set up yet"),
    ...
    "savgol_filter": xp_capabilities(
        cpu_only=True, exceptions=["cupy"], jax_jit=False, reason="convolve1d is cpu-only"
    ),
    ...
    "sosfilt": xp_capabilities(cpu_only=True, exceptions=["cupy"], allow_dask_compute=True),
