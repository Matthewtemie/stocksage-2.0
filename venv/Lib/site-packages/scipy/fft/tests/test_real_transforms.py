...
from scipy._lib._array_api import xp_copy, xp_assert_close, make_xp_test_case, make_xp_pytest_param
...
@pytest.mark.parametrize(
    "forward, backward", [make_xp_pytest_param(dct, idct), make_xp_pytest_param(dst, idst)]
)
...
@pytest.mark.parametrize(
    "forward, backward", [make_xp_pytest_param(dctn, idctn), make_xp_pytest_param(dstn, idstn)]
)
@pytest.mark.parametrize("type", [1, 2, 3, 4])
@pytest.mark.parametrize(
    "shape, axes",
...
@pytest.mark.parametrize(
    "func, type",
    [make_xp_pytest_param(dct, 4), make_xp_pytest_param(dst, 1), make_xp_pytest_param(dst, 4)],
)
