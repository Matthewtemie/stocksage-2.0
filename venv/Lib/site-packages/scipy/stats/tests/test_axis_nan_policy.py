...
axis_nan_policy_cases = [
    ...
    (stats.spearmanrho, tuple(), dict(), 2, 2, True, lambda res: (res.statistic, res.pvalue)),
    (
...
def test_axis_nan_policy_axis_is_None(
    ...
    if data_generator == "mixed" and nan_policy == "omit" and hypotest.__name__ == "xp_var":
        skip_nan_unexpected_exception()
    ...
    for samples in small_data_generator(n_samples, n_dims):
        ...
        for axis in range(-max_axis, max_axis):
            ...
            try:
                ...
                concat = stats._axis_nan_policy._broadcast_concatenate(samples, axis, paired=paired)
                with warnings.catch_warnings():
                    warnings.filterwarnings("ignore", "Mean of empty slice", RuntimeWarning)
...
def test_non_broadcastable(hypotest, args, kwds, n_samples, n_outputs, paired, unpacker, axis):
