...
class TestMGCStat:
    ...
    def test_twosamp(self):
        ...
        # test stat and pvalue
        stat, pvalue, _ = stats.multiscale_graphcorr(x, y, is_twosamp=True, random_state=self.rng)
        assert_approx_equal(stat, 1.0, significant=1)
        assert_approx_equal(pvalue, 0.001, significant=1)
    ...
    def test_workers(self):
        ...
        # test stat and pvalue
        stat, pvalue, _ = stats.multiscale_graphcorr(x, y, workers=2, random_state=self.rng)
