...
def test_moments(distname, arg, normalization_ok, higher_ok, moment_ok, is_xfailing):
    ...
    with warnings.catch_warnings():
        ...
        warnings.filterwarnings("ignore", "The algorithm does not converge.", IntegrationWarning)
...
def check_fit_args(distfn, arg, rvs, method):
    with np.errstate(all="ignore"), warnings.catch_warnings():
        warnings.filterwarnings(
            "ignore", category=RuntimeWarning, message="The shape parameter of the erlang"
        )
        warnings.filterwarnings(
