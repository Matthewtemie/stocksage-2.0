...
class _FuncInfo:
    ...
    generic_impl: Callable[[ModuleType, ModuleType | None], Callable | None] | None = None
    ...
    def _wrapper_for(self, xp):
        ...
        if is_marray(xp):
            ...
            def f(*args, _f=_f, xp=xp, **kwargs):
                ...
                mask = functools.reduce(operator.or_, (getattr(arg, "mask", False) for arg in args))
...
_special_funcs = (
    ...
    _FuncInfo(_ufuncs.betaincc, 3, _needs_betainc, generic_impl=_betaincc, torch_native=False),
    _FuncInfo(
        _ufuncs.betaincinv,
        3,
        xp_capabilities(
    ...
    _FuncInfo(_ufuncs.stdtr, 2, _needs_betainc, generic_impl=_stdtr, torch_native=False),
    _FuncInfo(
        _ufuncs.stdtrit,
        2,
        xp_capabilities(
