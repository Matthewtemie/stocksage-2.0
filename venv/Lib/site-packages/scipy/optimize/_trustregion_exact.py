...
class IterativeSubproblem(BaseQuadraticSubproblem):
    ...
    def __init__(self, x, fun, jac, hess, hessp=None, k_easy=0.1, k_hard=0.2, maxiter=None):
        ...
        if self.maxiter < 0:
            raise ValueError(
                "maxiter must not be set to a negative number" ", use np.inf to mean infinite."
            )
