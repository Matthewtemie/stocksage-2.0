...
from numpy.testing import assert_equal, assert_array_almost_equal, assert_array_almost_equal_nulp
    ...
    def test_line_search_wolfe2(self):
        ...
        for name, f, fprime, x, p, old_f in self.line_iter():
            ...
            with warnings.catch_warnings():
                ...
                warnings.filterwarnings(
                    "ignore", "The line search algorithm did not converge", LineSearchWarning
                )
