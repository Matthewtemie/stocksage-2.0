...
class TestDifferentialEvolutionSolver:
    ...
    def test_polish_function(self):
        ...
        with assert_raises(ValueError, match="The result from a user defined polishing"):
        ...
        res = differential_evolution(rosen, self.bounds, polish=False, rng=rng, maxiter=1)
