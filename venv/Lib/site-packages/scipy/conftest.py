...
xp_available_backends = [pytest.param(np, id="numpy", marks=pytest.mark.array_api_backends)]
...
if SCIPY_ARRAY_API:
    ...
    try:
        ...
        xp_available_backends.append(
            pytest.param(
                array_api_strict, id="array_api_strict", marks=pytest.mark.array_api_backends
            )
        )
