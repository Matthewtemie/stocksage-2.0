...
from scipy._lib._array_api import _asarray, array_namespace, xp_size, is_numpy, xp_capabilities
    ...
    def _chunk_evaluator(self, x, y, shift, scale, coeffs, memory_budget=1000000):
        ...
        if chunksize <= nx:
            ...
            out = _backend.compute_interpolation(
                x, y, self.kernel, self.epsilon, self.powers, shift, scale, coeffs, self._xp
            )
        return out
