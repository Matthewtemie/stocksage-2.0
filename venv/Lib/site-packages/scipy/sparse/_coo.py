...
class _coo_base(_data_matrix, _minmax_mixin):
    ...
    def __getitem__(self, key):
        index, new_shape, arr_int_pos, none_pos = _validate_indices(key, self.shape, self.format)
    ...
    def _dense_tensordot(self, other, s_axes, o_axes):
        ...
        reshape_right = (*o_non_axes_shape[:-1], math.prod(o_axes_shape), *o_non_axes_shape[-1:])
