...
class _cs_matrix(_data_matrix, _minmax_mixin, IndexMixin):
    ...
    def _matmul_sparse(self, other):
        ...
        csr_matmat(
            M, N, s_indptr, s_indices, s.data, o_indptr, o_indices, o.data, indptr, indices, data
        )
    ...
    def _major_index_fancy(self, idx):
        ...
        csr_row_index(M, indices, self_indptr, self_indices, self.data, res_indices, res_data)
