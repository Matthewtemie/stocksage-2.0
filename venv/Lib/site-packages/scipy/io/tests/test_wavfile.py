...
import numpy as np
from numpy.testing import assert_equal, assert_, assert_array_equal, break_cycles, IS_PYPY
import pytest
    ...
    for mmap in [False, True]:
        with warnings.catch_warnings():
            warnings.filterwarnings(
                "ignore", "Chunk .non-data. not understood, skipping it", wavfile.WavFileWarning
            )
