...
capabilities_dict = {
    "geometric_transform": xp_capabilities(cpu_only=True, allow_dask_compute=True, jax_jit=False),
    "find_objects": xp_capabilities(cpu_only=True, allow_dask_compute=True, jax_jit=False),
    "distance_transform_bf": xp_capabilities(cpu_only=True, allow_dask_compute=True, jax_jit=False),
    "distance_transform_cdt": xp_capabilities(
        cpu_only=True, allow_dask_compute=True, jax_jit=False
    ),
    "vectorized_filter": xp_capabilities(cpu_only=True, allow_dask_compute=True, jax_jit=False),
    "generate_binary_structure": xp_capabilities(out_of_scope=True),
    "map_coordinates": xp_capabilities(
        cpu_only=True, exceptions=["cupy", "jax.numpy"], allow_dask_compute=True, jax_jit=True
    ),
}
