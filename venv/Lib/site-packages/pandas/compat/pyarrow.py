...
def _safe_fill_null(arr: pa.Array | pa.ChunkedArray, fill_value: Any) -> pa.Array | pa.ChunkedArray:
    """
    ...
    use_fallback = HAS_PYARROW and is_windows and not pa_version_under21p0 and pa_version_under22p0
