...
class CategoricalDtype(PandasExtensionDtype, ExtensionDtype):
    ...
    def _get_common_dtype(self, dtypes: list[DtypeObj]) -> DtypeObj | None:
        ...
        non_cat_dtypes = [
            x.categories.dtype if isinstance(x, CategoricalDtype) else x for x in subtypes
        ]
...
class PeriodDtype(PeriodDtypeBase, PandasExtensionDtype):
    ...
    **This is not an actual numpy dtype**, but a duck type.
    ...
    def construct_from_string(cls, string: str_type) -> PeriodDtype:
        ...
        possible
        """
        if (isinstance(string, str) and (string.startswith(("period[", "Period[")))) or isinstance(
            string, BaseOffset
        ):
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if isinstance(other, type(self)):
            ...
            if self._is_na_fill_value or other._is_na_fill_value:
                ...
                fill_value = isinstance(self.fill_value, type(other.fill_value)) or isinstance(
                    other.fill_value, type(self.fill_value)
                )
            else:
...
class ArrowDtype(StorageExtensionDtype):
    ...
    def __init__(self, pyarrow_dtype: pa.DataType) -> None:
        ...
        if not HAS_PYARROW:
            raise ImportError(f"pyarrow>={PYARROW_MIN_VERSION} is required for ArrowDtype")
