...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    def reindex(
        ...
        * ``(labels, axis={'index', 'columns'}, ...)``
        ...
        return self._reindex_axes(axes, level, limit, tolerance, method, fill_value).__finalize__(
            self, method="reindex"
        )
    ...
    def __finalize__(self, other, method: str | None = None, **kwargs) -> Self:
        ...
        if isinstance(other, NDFrame):
            ...
            self.flags.allows_duplicate_labels = (
                self.flags.allows_duplicate_labels and other.flags.allows_duplicate_labels
            )
        ...
        if self.ndim == 1:
            ...
            if axis == 1:
                ...
                if not can_hold_element(result.iloc[:, 0], value):
                    ...
                    raise ValueError(f"{value} not a suitable type to fill into {frame_dtype}")
