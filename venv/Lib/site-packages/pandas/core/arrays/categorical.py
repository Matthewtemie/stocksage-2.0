...
class Categorical(NDArrayBackedExtensionArray, PandasObject, ObjectStringArrayMixin):
    ...
    def _from_inferred_categories(
        ...
        if known_categories:
            ...
            codes = recode_for_categories(inferred_codes, cats, categories, copy=False, warn=True)
    ...
    def _set_dtype(self, dtype: CategoricalDtype, *, copy: bool) -> Self:
        ...
        """
        codes = recode_for_categories(self.codes, self.categories, dtype.categories, copy=copy)
