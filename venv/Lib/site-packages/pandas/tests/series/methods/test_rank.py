...
class TestSeriesRank:
    ...
    def test_rank_tie_methods(self, ser, results, dtype, using_infer_string, using_nan_is_na):
        method, exp = results
        if (
            dtype == "int64"
            or (
    ...
    def test_rank_descending(self, ser, results, dtype, using_infer_string, using_nan_is_na):
        method, _ = results
        if (
            dtype == "int64"
