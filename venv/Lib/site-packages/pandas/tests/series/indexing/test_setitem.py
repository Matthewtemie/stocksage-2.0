...
class TestSetitemWithExpansion:
    def test_setitem_empty_series(self, using_infer_string):
        ...
        series[key] = 47
        expected = Series(47, index=[key] if using_infer_string else Index([key], dtype=object))
    ...
    def test_setitem_enlarge_with_na(self, na, target_na, dtype, target_dtype, indexer, raises):
        # GH#32346
