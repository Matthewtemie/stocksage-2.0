...
class TestSeriesConstructors:
    ...
    def test_constructor_dict_datetime64_index(self):
        ...
        tm.assert_series_equal(result_datetime64, expected.set_axis(expected.index.as_unit("s")))
    ...
    def test_series_string_inference_storage_definition(self):
        ...
        expected = Series(["a", "b"], dtype="string[pyarrow]" if HAS_PYARROW else "string[python]")
        with pd.option_context("future.infer_string", True):
