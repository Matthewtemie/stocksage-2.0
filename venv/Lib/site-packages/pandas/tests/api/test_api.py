...
def get_pandas_objects(module_name: str, recurse: bool) -> list[tuple[str, str, object]]:
    """
    ...
    for module_info in pkgutil.walk_packages(paths):
        ...
        if name.startswith("_") or name == "internals":
            continue
        objs.extend(get_pandas_objects(f"{module.__name__}.{name}", recurse=module_info.ispkg))
    return objs
