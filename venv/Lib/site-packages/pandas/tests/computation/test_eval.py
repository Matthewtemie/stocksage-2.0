...
class TestAlignment:
    ...
    def test_performance_warning_for_poor_alignment(self, performance_warning, engine, parser):
...
class TestOperations:
    ...
    def test_simple_arith_ops(self, engine, parser):
        ...
        arith_ops = [
            op for op in expr.ARITH_OPS_SYMS + expr.CMP_OPS_SYMS if op not in exclude_arith
        ]
