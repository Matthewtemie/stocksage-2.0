...
class TestExpressions:
    ...
    def test_bool_ops_warn_on_arithmetic(self, op_str, opname, monkeypatch):
        ...
        warning = (
            UserWarning
            if ne and op_str in {"+", "*"} and Version(ne.__version__) < Version("2.13.1")
            else None
        )
        with monkeypatch.context() as m:
    ...
    def test_python_semantics_with_numexpr_installed(self, op, box_with_array, scalar, monkeypatch):
