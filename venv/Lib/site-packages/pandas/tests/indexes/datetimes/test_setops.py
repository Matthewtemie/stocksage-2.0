...
class TestDatetimeIndexSetOps:
    ...
    def test_intersection(self, tz, sort):
        ...
        # GH 7880
        rng4 = date_range("7/1/2000", "7/31/2000", freq="D", tz=tz, unit="ns", name="idx")
...
class TestCustomDatetimeIndex:
    ...
    @pytest.mark.parametrize("tz", [None, "UTC", "Europe/Berlin", timezone(timedelta(hours=-1))])
...
def test_union_non_nano_rangelike():
    # GH 59036
    l1 = DatetimeIndex(["2024-05-11", "2024-05-12"], dtype="datetime64[us]", name="Date", freq="D")
