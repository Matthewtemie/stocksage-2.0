...
class TestDatetimeIndex:
    ...
    def test_dti_tz_constructors(self, tzstr):
        ...
        idx2 = date_range(start="2005-11-10 08:00:00", freq="h", periods=2, tz=tzstr, unit="us")
    ...
    def test_dti_constructor_with_non_nano_now_today(self, request):
        ...
        # GH 57535
        request.applymarker(
            pytest.mark.xfail(reason="result may not exactly match [now, today]", strict=False)
        )
