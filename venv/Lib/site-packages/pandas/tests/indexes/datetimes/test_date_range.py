...
class TestDateRanges:
    ...
    def test_date_range_normalize(self):
        ...
        offset = timedelta(2)
        expected = DatetimeIndex([snap + i * offset for i in range(n)], dtype="M8[us]", freq=offset)
    ...
    @pytest.mark.parametrize("freq_depr", ["m", "bm", "CBM", "SM", "BQ", "q-feb", "y-may", "Y-MAY"])
    ...
    def test_date_range_depr_lowercase_frequency(self, freq, freq_depr):
        # GH#58998
        depr_msg = f"'{freq_depr[1:]}' is deprecated and will be removed in a future version."
    ...
    def test_error_message_for_removed_year_yearbegin_frequencies(self, freq, freq_removed):
...
class TestGenRangeGeneration:
    ...
    def test_precision_finer_than_offset(self):
        ...
        expected1 = DatetimeIndex(expected1_list, dtype="datetime64[us]", freq="QE-DEC", tz=None)
        expected2 = DatetimeIndex(expected2_list, dtype="datetime64[us]", freq="W-SUN", tz=None)
...
class TestCustomDateRange:
    ...
    def test_cdaterange_deprecated_error_CBH(self):
        ...
        with pytest.raises(ValueError, match=msg):
            bdate_range(START, END, freq="CBH", weekmask="Mon Wed Fri", holidays=["2009-03-14"])
...
class TestDateRangeNonTickFreq:
    ...
    def test_date_range_tzaware_endpoints_accept_ambiguous(self):
        ...
        exp = date_range("1916-08-01", "1916-12-01", freq="MS", tz="Europe/Oslo", ambiguous=True)
    ...
    def test_date_range_tzaware_endpoints_accept_nonexistent(self):
        ...
        expected = date_range("2015-03-28 01:30", "2015-03-30 01:30", freq="D").tz_localize(
