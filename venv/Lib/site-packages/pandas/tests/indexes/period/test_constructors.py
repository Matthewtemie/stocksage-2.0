...
class TestPeriodIndexDisallowedFreqs:
    ...
    def test_period_index_depr_lowercase_frequency(self, freq, freq_depr):
        ...
        with tm.assert_produces_warning(Pandas4Warning, match=msg, raise_on_extra_warnings=False):
...
class TestPeriodIndex:
    ...
    def test_constructor_invalid_quarters(self):
        ...
        with pytest.raises(ValueError, match=msg):
            PeriodIndex.from_fields(year=range(2000, 2004), quarter=list(range(4)), freq="Q-DEC")
