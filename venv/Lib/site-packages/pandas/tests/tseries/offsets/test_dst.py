...
class TestDST:
    ...
    def _test_offset(self, offset_name, offset_n, tstart, expected_utc_offset, performance_warning):
        ...
        if (
            ...
            and offset_n == 1
            and tstart
            == Timestamp("2013-11-03 01:59:59.999999-0500", tz=pytz.timezone("US/Eastern"))
        ):
