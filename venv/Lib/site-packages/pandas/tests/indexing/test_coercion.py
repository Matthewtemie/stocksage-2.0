...
class TestInsertIndexCoercion(CoercionBase):
    ...
    def test_insert_index_timedelta64(self):
        ...
        self._assert_insert_conversion(obj, pd.Timedelta("10 day"), exp, "timedelta64[us]")
...
class TestWhereCoercion(CoercionBase):
    ...
    def test_where_datetime64(self, index_or_series, fill_val, exp_dtype):
        ...
        obj = klass(pd.date_range("2011-01-01", periods=4, freq="D", unit="ns")._with_freq(None))
...
class TestReplaceSeriesCoercion(CoercionBase):
    ...
    def test_replace_series_datetime_tz(self, to_key, from_key, replacer, using_infer_string):
