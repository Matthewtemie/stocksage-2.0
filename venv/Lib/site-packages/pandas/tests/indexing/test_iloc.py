...
class TestiLocBaseIndependent:
    ...
    def test_iloc_setitem_ea_inplace(self, frame_or_series, index_or_series_or_array, has_ref):
    ...
    @pytest.mark.skipif(pa_version_under16p0, reason="https://github.com/apache/arrow/issues/40642")
        ...
        for idx in [None, "index", "locs"]:
            ...
            for method in ["", ".loc", ".iloc"]:
                ...
                if (
                    ...
                    assert expected_result == answer, f"[{key}] does not match [{answer}]"
                else:
...
class TestILocSeries:
    ...
    def test_iloc_arrow_extension_array(self):
        ...
        df_arrow = DataFrame({"a": [1, 2], "c": [0, 2], "d": ["c", "a"]}).convert_dtypes(
