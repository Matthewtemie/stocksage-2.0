...
def left_right():
    ...
    right = left.sample(frac=1, random_state=np.random.default_rng(2), ignore_index=True)
...
class TestSorting:
    ...
    def test_int64_overflow_groupby_large_df_shuffled(self, agg):
        ...
        assert is_int64_overflow_possible(tuple(ping.ngroups for ping in gr._grouper.groupings))
...
class TestSafeSort:
    ...
    @pytest.mark.parametrize("arg, exp", [[[1, 3, 2], [1, 2, 3]], [[1, 3, NA, 2], [1, 2, 3, NA]]])
