...
class TestAstype:
    ...
    @pytest.mark.filterwarnings("ignore:Constructing a Categorical with a dtype and values")
    ...
    def test_astype_tz_conversion(self):
        ...
        with tm.assert_produces_warning(Pandas4Warning, match=msg):
            val = {
                "tz": date_range("2020-08-30", freq="d", periods=2, tz="Europe/London", unit="ns")
            }
        df = DataFrame(val)
    ...
    def test_astype_tz_object_conversion(self, tz):
        # GH 35973
        val = {"tz": date_range("2020-08-30", freq="D", periods=2, tz="Europe/London", unit="ns")}
