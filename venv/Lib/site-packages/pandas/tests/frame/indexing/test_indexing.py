...
class TestDataFrameIndexing:
    ...
    def test_type_error_multiindex(self):
        ...
        dg = DataFrame([[1, 1, 2, 2], [3, 3, 4, 4]], columns=mi, index=Index(range(2), name="i"))
...
class TestLocILocDataFrameCategorical:
    ...
    def test_loc_iloc_setitem_non_categorical_rhs(self, orig, exp_parts_cats_col, indexer_li):
