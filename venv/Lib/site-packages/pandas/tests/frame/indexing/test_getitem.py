...
class TestGetitemListLike:
    ...
    def test_getitem_iloc_dateoffset_days(self):
        ...
        df = DataFrame(
            list(range(10)),
            index=date_range("01-01-2022", periods=10, freq=DateOffset(days=1), unit="ns"),
        )
        ...
        df = DataFrame(
            list(range(10)),
            index=date_range("01-01-2022", periods=10, freq=DateOffset(days=1, hours=2), unit="ns"),
        )
        result = df.loc["2022-01-01":"2022-01-03"]
        expected = DataFrame(
            [0, 1, 2],
        ...
        df = DataFrame(
            list(range(10)),
            index=date_range("01-01-2022", periods=10, freq=DateOffset(minutes=3), unit="ns"),
        )
        result = df.loc["2022-01-01":"2022-01-03"]
