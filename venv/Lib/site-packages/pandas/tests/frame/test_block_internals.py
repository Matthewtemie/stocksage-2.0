...
class TestDataFrameBlockInternals:
    ...
    def test_strange_column_corruption_issue(self, performance_warning):
        ...
        with tm.assert_produces_warning(performance_warning, raise_on_extra_warnings=False):
...
def test_multithreaded_reading():
    ...
    tm.run_multithreaded(concat, max_workers=8, arguments=(get_longley_data(),), pass_barrier=True)
