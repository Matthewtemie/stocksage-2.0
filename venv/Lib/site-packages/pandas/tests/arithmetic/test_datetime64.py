...
class TestDatetime64Arithmetic:
    ...
    def test_dt64arr_sub_timestamp_tzaware(self, box_with_array):
        ...
        delta_series = Series([np.timedelta64(0, "D"), np.timedelta64(1, "D")], dtype="m8[ns]")
    ...
    def test_dt64arr_addsub_intlike(self, dtype, index_or_series_or_array, freq, tz_naive_fixture):
...
class TestDatetime64DateOffsetArithmetic:
    ...
    def test_dti_add_sub_nonzero_mth_offset(
        ...
        # GH 26258
        tz = tz_aware_fixture
        date = date_range(start="01 Jan 2014", end="01 Jan 2017", freq="YS", tz=tz, unit="ns")
...
class TestTimestampSeriesArithmetic:
    ...
    def test_sub_datetime_compat(self, unit):
        # see GH#14088
        ser = Series([datetime(2016, 8, 23, 12, tzinfo=timezone.utc), NaT]).dt.as_unit(unit)
