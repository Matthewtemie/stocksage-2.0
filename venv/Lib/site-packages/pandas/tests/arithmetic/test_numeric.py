...
class TestNumericArraylikeArithmeticWithDatetimeLike:
    ...
    def test_numeric_arr_mul_tdscalar(self, scalar_td, numeric_idx, box_with_array):
        ...
        box = box_with_array
        index = numeric_idx
        expected = TimedeltaIndex([Timedelta(days=n) for n in range(len(index))], dtype="m8[ns]")
    ...
    @pytest.mark.filterwarnings("ignore:.*'generic' unit for NumPy timedelta:DeprecationWarning")
