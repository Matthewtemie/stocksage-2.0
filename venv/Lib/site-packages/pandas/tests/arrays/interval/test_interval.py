...
class TestMethods:
    ...
    def test_unique_with_negatives(self):
        # GH#61917
        idx_pos = IntervalIndex.from_tuples([(3, 4), (3, 4), (2, 3), (2, 3), (1, 2), (1, 2)])
        ...
        idx_mix = IntervalIndex.from_tuples([(1, 2), (0, 1), (-1, 0), (-2, -1), (-3, -2), (-3, -2)])
        result = idx_mix.unique()
        expected = IntervalIndex.from_tuples([(1, 2), (0, 1), (-1, 0), (-2, -1), (-3, -2)])
        tm.assert_index_equal(result, expected)
