...
def datetime_index(freqstr):
    ...
    dti = pd.date_range(start=Timestamp("2000-01-01"), periods=100, freq=freqstr, unit="ns")
    return dti
...
class SharedTests:
    ...
    def test_searchsorted_castable_strings(self, arr1d, box, string_storage, using_infer_string):
        arr = arr1d
        if box is None:
            pass
        elif box == "index":
...
class TestDatetimeArray(SharedTests):
    ...
    def arr1d(self, tz_naive_fixture, freqstr):
        ...
        """
        tz = tz_naive_fixture
        dti = pd.date_range("2016-01-01 01:01:00", periods=5, freq=freqstr, tz=tz, unit="ns")
        dta = dti._data
        return dta
