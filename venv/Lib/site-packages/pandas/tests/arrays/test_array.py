...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            None,
            NumpyExtensionArray(np.array([complex(1), complex(2)], dtype=np.complex128)),
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            [
                datetime.datetime(2000, 1, 1, tzinfo=zoneinfo.ZoneInfo("Europe/Berlin")),
                datetime.datetime(2001, 1, 1, tzinfo=zoneinfo.ZoneInfo("Europe/Berlin")),
            ],
            DatetimeArray._from_sequence(
                ["2000", "2001"],
                dtype=pd.DatetimeTZDtype(tz=zoneinfo.ZoneInfo("Europe/Berlin"), unit="us"),
            ),
        ),
        # timedelta
        (
