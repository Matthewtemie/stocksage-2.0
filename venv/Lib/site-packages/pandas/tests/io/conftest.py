...
@pytest.fixture
def s3_bucket_public_with_data(s3_bucket_public, tips_file, jsonl_file, feather_file, xml_file):
    """
...
@pytest.fixture
def s3_bucket_private_with_data(s3_bucket_private, tips_file, jsonl_file, feather_file, xml_file):
    """
    The following datasets
    are loaded.
