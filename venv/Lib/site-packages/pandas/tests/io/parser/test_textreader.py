...
class TestTextReader:
    ...
    def test_skipinitialspace(self):
        ...
        reader = TextReader(StringIO(data), skipinitialspace=True, header=None, **_na_value_kwargs)
        result = reader.read()
    ...
    def test_delimit_whitespace(self):
        ...
        reader = TextReader(StringIO(data), delim_whitespace=True, header=None, **_na_value_kwargs)
        result = reader.read()
    ...
    def test_skip_bad_lines(self):
        ...
        reader = TextReader(StringIO(data), delimiter=":", header=None, **_na_value_kwargs)
