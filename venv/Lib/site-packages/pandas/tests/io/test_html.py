...
class TestReadHtml:
    ...
    def test_invalid_url(self, httpserver, flavor_read_html):
        ...
        try:
            with pytest.raises((URLError, ValueError), match="HTTP Error 404: NOT FOUND") as err:
    ...
    def test_banklist_header(self, banklist_data, datapath, flavor_read_html):
        ...
        gtnew = gtnew[gtnew["Bank Name"].isin(converted["Bank Name"])].reset_index(drop=True)
