...
class TestBasic(Base):
    ...
    def test_compression(self, engine, compression, temp_file):
        ...
        check_round_trip(df, temp_file, engine, write_kwargs={"compression": compression})
    ...
    def test_write_ignoring_index(self, engine, temp_file):
        ...
        check_round_trip(df, temp_file, engine, write_kwargs=write_kwargs, expected=expected)
...
class TestParquetPyArrow(Base):
    ...
    def test_duplicate_columns(self, pa, temp_file):
        ...
        self.check_error_on_write(df, pa, ValueError, "Duplicate column names found", temp_file)
    ...
    @pytest.mark.single_cpu
    def test_s3_roundtrip_explicit_fs(self, df_compat, s3_bucket_public, s3so, pa, temp_file):
    ...
    def test_write_with_schema(self, pa, temp_file):
        ...
        check_round_trip(df, temp_file, pa, write_kwargs={"schema": schema}, expected=out_df)
    ...
    def test_pyarrow_backed_string_array(self, pa, string_storage, using_infer_string, temp_file):
    ...
    def test_maps_as_pydicts(self, pa, temp_file):
        ...
        schema = pyarrow.schema([("foo", pyarrow.map_(pyarrow.string(), pyarrow.int64()))])
...
class TestParquetFastParquet(Base):
    ...
    def test_timezone_aware_index(self, fp, timezone_aware_date_list, request, temp_file):
        idx = 5 * [timezone_aware_date_list]
