                    ...
                    if typ in ("frame", "sp_frame"):
                        ...
                        if dt in ("mixed", "mixed_dup"):
                            ...
                            expected["A"] = expected["A"].astype(
                                pd.CategoricalDtype(expected["A"].cat.categories.astype(object))
                            )
                        ...
                        if dt == "ts":
                            ...
                            expected = expected.astype(
                                pd.CategoricalDtype(expected.cat.categories.astype(object))
                            )
                        elif dt == "dup":
...
def test_pickle_preserve_name(name, temp_file):
    unpickled = tm.round_trip_pickle(Series(np.arange(10, dtype=np.float64), name=name), temp_file)
