...
class TestTableOrientReader:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            {"objects": ["a", "b", "c", "d"]},
            {"objects": ["1", "2", "3", "4"]},
            {"date_ranges": pd.date_range("2016-01-01", freq="D", periods=4, unit="ns")},
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pd.date_range("2020-08-30", freq="D", periods=4, tz="US/Central", unit="ns")._with_freq(
                None
            ),
            pd.MultiIndex.from_product(
                [
                    pd.date_range("2020-08-30", freq="D", periods=2, tz="US/Central", unit="ns"),
                    ["x", "y"],
                ],
            ),
        ],
        ...
        df = DataFrame(
            {
                ...
                "F": pd.Series(pd.Categorical(["a", "b", "c", "c"], ordered=True)),
                "G": [1.1, 2.2, 3.3, 4.4],
                "H": pd.date_range("2016-01-01", freq="D", periods=4, tz="US/Central", unit="ns"),
