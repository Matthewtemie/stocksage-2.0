...
class TestFancyIndexingCast:
    def test_boolean_index_cast_assign(self):
        ...
        pytest.warns(ComplexWarning, zero_array.__setitem__, ([0], [1]), np.array([2 + 1j]))
...
class TestFlatiterIndexing:
    ...
    def test_flatiter_indexing_fancy(self):
        ...
        with pytest.raises(IndexError, match="boolean indices for iterators are not supported"):
            a.flat[[True, True]]
    ...
    def test_flatiter_indexing_slice_assign(self):
        ...
        a = np.arange(9).reshape((3, 3))
        with pytest.raises(IndexError, match="Assigning to a flat iterator with a 0-D index"):
            a.flat[()] = 70
