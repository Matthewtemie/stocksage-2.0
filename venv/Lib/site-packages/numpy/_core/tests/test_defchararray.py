...
class TestComparisons:
    def A(self):
        return np.array([["abc", "abcc", "123"], ["789", "abc", "xyz"]]).view(np.char.chararray)

    def B(self):
        return np.array([["efg", "efg", "123  "], ["051", "efgg", "tuv"]]).view(np.char.chararray)
...
class TestComparisonsMixed1(TestComparisons):
    ...
    def B(self):
        return np.array([["efg", "efg", "123  "], ["051", "efgg", "tuv"]], np.str_).view(
            np.char.chararray
        )
...
class TestInformation:
    def A(self):
        return np.array([[" abc ", ""], ["12345", "MixedCase"], ["123 \t 345 \0 ", "UPPER"]]).view(
            np.char.chararray
        )
...
class TestMethods:
    ...
    def test_isnumeric(self):
        ...
        assert_array_equal(B.isnumeric(), [[False, False], [True, False], [False, False]])
    ...
    def test_isdecimal(self):
        ...
        assert_array_equal(B.isdecimal(), [[False, False], [True, False], [False, False]])
