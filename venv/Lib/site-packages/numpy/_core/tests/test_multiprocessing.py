...
pytestmark = pytest.mark.thread_unsafe(reason="tests in this module are explicitly multi-processed")
...
@pytest.mark.skipif(
    IS_PYPY and sys.platform == "win32", reason="_winapi does not support UnmapViewOfFile"
)
