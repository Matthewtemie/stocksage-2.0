...
class TestCasting:
    ...
    @pytest.mark.parametrize("to_dtype", np.typecodes["AllInteger"] + np.typecodes["AllFloat"])
    @pytest.mark.parametrize("from_dtype", np.typecodes["AllInteger"] + np.typecodes["AllFloat"])
    @pytest.mark.filterwarnings("ignore::numpy.exceptions.ComplexWarning")
