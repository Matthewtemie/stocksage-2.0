...
class TestRandomDist:
    ...
    def test_multivariate_normal(self):
        ...
        assert_raises(ValueError, rng.multivariate_normal, mean, cov, check_valid="raise")
        ...
        mu = np.zeros(2)
        cov = np.eye(2)
        assert_raises(ValueError, rng.multivariate_normal, mean, cov, check_valid="other")
