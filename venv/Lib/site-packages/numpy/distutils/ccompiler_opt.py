...
class _Config:
    ...
    conf_features = dict(
        ...
        AVX512F=dict(
            interest=20, implies="FMA3 AVX2", implies_detect=False, extra_checks="AVX512F_REDUCE"
        ),
        ...
        ## Power9/ISA 3.00
        VSX3=dict(
            interest=3, implies="VSX2", implies_detect=False, extra_checks="VSX3_HALF_DOUBLE"
        ),
        ## Power10/ISA 3.1
...
class CCompilerOpt(_Config, _Distutils, _Cache, _CCompiler, _Feature, _Parse):
    ...
    def generate_dispatch_header(self, header_path):
        ...
        if not os.path.exists(header_dir):
            self.dist_log(
                f"dispatch header dir {header_dir} does not exist, creating it", stderr=True
            )
        ...
        with open(header_path, "w") as f:
            ...
            """
                    ...
                    pfx=self.conf_c_prefix_, baseline_pre=baseline_pre, dispatch_pre=dispatch_pre
                )
            )
