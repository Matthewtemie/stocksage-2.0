...
from numpy.testing import assert_, assert_equal, IS_EDITABLE
...
class TestAppendpath:
    ...
    def test_3(self):
        assert_equal(
            appendpath("/prefix/sub", "/prefix/sup/name"), ajoin("prefix", "sub", "sup", "name")
        )
        assert_equal(
...
@pytest.mark.skipif(
    IS_EDITABLE, reason="`get_info` .ini lookup method incompatible with editable install"
)
