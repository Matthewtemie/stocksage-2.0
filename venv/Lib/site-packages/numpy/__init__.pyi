...
_NumberCharacterArrayT = TypeVar(
    "_NumberCharacterArrayT", bound=ndarray[Any, dtype[number | character] | dtypes.StringDType]
)
...
class _ArrayOrScalarCommon:
    ...
    def tofile(
        self, fid: StrOrBytesPath | _SupportsFileMethods, /, sep: str = "", format: str = "%s"
    ) -> None: ...
...
class busdaycalendar:
    def __init__(
        ...
        /,
        weekmask: (
            str | Sequence[int | bool_ | integer] | _SupportsArray[dtype[bool_ | integer]]
        ) = "1111100",
