...
class Parameter(ABC):
    ...
    def handle_parse_result(
        ...
        with augment_usage_errors(ctx, param=self):
            ...
            if self.deprecated and value is not UNSET and source < ParameterSource.DEFAULT_MAP:
                message = _(
        ...
        is_winner = (
            slot_empty or more_explicit or (same_source and not auto_would_downgrade_explicit)
        )
...
class Option(Parameter):
    ...
    def _parse_decls(
        ...
        if name is None:
            ...
            raise TypeError(
                _("Could not determine name for option with declarations {decls!r}").format(
                    decls=decls
                )
            )
