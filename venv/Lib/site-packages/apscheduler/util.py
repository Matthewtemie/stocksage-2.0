...
def datetime_ceil(dateval):
    ...
    if dateval.microsecond > 0:
        return datetime_utc_add(dateval, timedelta(seconds=1, microseconds=-dateval.microsecond))
...
def check_callable_args(func, args, kwargs):
    ...
    if unsatisfied_args:
        raise ValueError(
            "The following arguments have not been supplied: {}".format(", ".join(unsatisfied_args))
        )
